...
\section{Justificación del uso de IA}
  \begin{frame}
    \frametitle{Justificación del uso de IA}
      La mayoría de los cometidos que implican inteligencia requieren abilidad
...
\section{Aplicaciones relevantes}
  \begin{frame}
   ...
   \pause
   \begin{itemize}[<+->]
    \item \textbf{Binaria:} clasificar en 2 clases (0-1, Verdadero-Falso). Ej.
      Dataset sobre la predicción de la diabetes 
    ...
    \item \textbf{Multiclase:} se usa una característica con tantos valores como clases, de
      manera que se clasifican los datos en más de dos clases. Como ejemplo extraído de la plataforma
    \hlink{http://www.Kaggle.com}{Kaggle} se plantea el problema del 
