...
\subsection{Relevancia del problema}
  \begin{frame}
    ...
    \begin{itemize}[<+->]
  	 ...
  	 \item Categorización de texto e imágenes, reconocimiento facial, detección de fraude
     \item ...
    \end{itemize}
    
    \uncover<6->{Por tanto la clasificación tiene beneficios económicos, para los usuarios y
