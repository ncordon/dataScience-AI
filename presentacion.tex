  ...
  \subsection{Aplicación 1}
    \begin{frame}
      ...
      \begin{columns}[T]
       ...
       \end{column}
       \begin{column}{.5\textwidth}
	  \includegraphics[width=\textwidth]{imgs/knn.png} % From http://en.wikipedia.org/wiki/File:Map1NN.png
	  \\~\\
	  \includegraphics[width=\textwidth]{imgs/digit_database.jpg} % From http://cs-people.bu.edu/athitsos/nearest-neighbors/
       \end{column}
      \end{columns}
    \end{frame}
