   ...
   \begin{columns}[T]
	...
	\begin{itemize}
	  ...
	  \item \textbf{Multietiqueta:} cada instancia se puede asociar a más de una etiqueta ($\approx$ clase). 
	      Ej. clasificación de música según las emociones que transmite: \hlink{http://mlkd.csd.auth.gr/publication_details.asp?publicationID=269}{Emotions Dataset}
    ...
    \bibitem[Herrera, 2015]{h1} Francisco Herrera Triguero
     ...
     \bibitem[Charte]{c1} David Charte Luque
      ...
      \bibitem[Freitas]{f1} Alex A. Freitas
       \newblock A Survey of Evolutionary Algorithms for Data Mining and Knowledge Discovery
       \newblock Introduction
       
      \bibitem[UCI]{uci} UCI Machine Learning Repository
	\newblock Dataset \hlink{https://archive.ics.uci.edu/ml/datasets/Pima+Indians+Diabetes}{Pima Indians Diabetes}
  \end{thebibliography}
}
\end{frame}
\end{document} 
